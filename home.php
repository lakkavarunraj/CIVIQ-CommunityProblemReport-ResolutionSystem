...
if (isset($_SESSION['email'])) {
    ...
    $_SESSION['email'] = $user; // Re-establish the session
} else {
...
<div class="container-fluid position-relative p-0">
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <!-- Buttons on Right -->
                <a href="pro.php" class="btn-custom">Profile</a>
            </div>
        </div>
    </nav>
            ...
            <div class="row justify-content-center py-5">
                <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <div class="position-relative w-75 mx-auto animated slideInDown">
                        ...
                        <button type="button" class="btn-custom position-absolute top-0 end-0 me-2" style="margin-top: 7px;" onclick="window.location.href='report.html';">Report</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <form>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-outline-light w-100 py-3" type="submit" onclick="window.location.href='report.html';">Report Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="position-relative mx-auto" style="max-width: 400px;">
                        ...
                        <button type="button" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2" onclick="window.location.href='contact.html';">Contact</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">CiviQ</a>, All Right Reserved.
